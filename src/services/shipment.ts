...
export async function printBarCode(params: { fnsku: string }) {
...
// shipment/getLabels
export async function getLabels(params: { shipment_id: string, page_type: string, label_type: string, package_labels_to_print: string }) {

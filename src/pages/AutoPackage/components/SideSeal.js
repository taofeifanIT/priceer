...
const Package = (props) => {
  ...
  const detail = {
    ...
    barcodeHeight: boxInfo.barcodeHeight,
    barcodeDegreeOfThickness: boxInfo.barcodeDegreeOfThickness,
  }
  ...
  const [barcodeDegreeOfThickness, setBarcodeDegreeOfThickness] = useState((cmToPx(height / 12) / 9));
